<template>
   <div class="receipt bg-white text-black p-4 mx-auto my-4 transition-all" style="width: 210mm; height: auto; font-family: sans-serif; min-height:400px; max-height: 1500px;">
