...
const invoiceNumber = ref(saleStore.invoice)
const customer = ref(saleStore.customer)
const formattedDate = ref(saleStore.date)
const paymentMethod = ref(saleStore.payment)
const products = ref(saleStore.products)
