<template>
  <div class="flex flex-col items-center justify-center max-h-screen p-4">
    ...
    <!-- Start/Stop Button -->
    <button @click="toggleCamera" class="mt-4 px-6 py-3 bg-primary rounded-[7px] border border-black transition hover:bg-blue-300 active:shadow-inner active:bg-blue-300">
